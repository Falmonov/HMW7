...
быть распечатаны. Нумерация строк и столбцов идет с единицы (подумайте, почему не с нуля). Примечание: бинарной операцией называется любая операция,
...
def print_operation_table(operation, num_rows=6, num_columns=6):
    n = [[operation(i, j) for j in range(1, num_columns + 1)] for i in range(1, num_rows + 1)]
    for i in n:
        print(*[x for x in i])
